...
const Hero = () => {
  ...
  return (
    <div className=" w-full relative overflow-hidden ">
      ...
      <div className="flex items-center justify-center gap-4 absolute transform md:bottom-10 -bottom-5 left-1/2 -translate-x-1/2 z-20">
        {[0, 1, 2].map((index) => (
          <div
            key={index}
      ...
      <div className="flex flex-col gap-4 absolute z-10 transform top-1/2 -translate-y-1/2 xl:pl-[200px] lg:pl-[80px] px-[30px] mt-34">
        ...
        <h1 className="font-poppins w-full max-w-[300px] lg:w-full lg:max-w-[631px] lg:text-[50px] text-[32px] font-bold text-white lg:leading-[70px]">
